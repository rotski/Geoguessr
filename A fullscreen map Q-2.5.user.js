// ==UserScript==
// @name         A fullscreen map Q
// @namespace    http://tampermonkey.net/
// @version      2.5
// @description  Expand the map to fullscreen in GeoGuessr and prevent it from becoming opaque or transparent when the mouse is moved off the map. Ensure it goes fullscreen as soon as the page loads. Press Q to toggle the script.
// @author       Your Name
...
(function() {
    ...
    // Add event listener for Q to toggle the script
